...
func (s *Server) observeDB(op string, start time.Time, err error) {
...
func (s *Server) createUser(w http.ResponseWriter, r *http.Request) {
	...
	s.observeDB("insert_user", start, err)
	if err != nil {
...
func (s *Server) listUsers(w http.ResponseWriter, r *http.Request) {
	...
	s.observeDB("select_users", start, err)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (s *Server) getUser(w http.ResponseWriter, r *http.Request) {
	...
	s.observeDB("select_user", start, err)
	if err != nil {
...
func (s *Server) updateUser(w http.ResponseWriter, r *http.Request) {
	...
	s.observeDB("update_user", start, err)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (s *Server) deleteUser(w http.ResponseWriter, r *http.Request) {
	...
	s.observeDB("delete_user", start, err)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (s *Server) createOrder(w http.ResponseWriter, r *http.Request) {
	...
	s.observeDB("insert_order", start, err)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (s *Server) listOrders(w http.ResponseWriter, r *http.Request) {
	...
	s.observeDB("select_orders", start, err)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (s *Server) getOrder(w http.ResponseWriter, r *http.Request) {
	...
	s.observeDB("select_order", start, err)
	if err != nil {
		if err == sql.ErrNoRows {
			http.Error(w, "not found", http.StatusNotFound)
			return
...
func (s *Server) updateOrder(w http.ResponseWriter, r *http.Request) {
	...
	s.observeDB("update_order", start, err)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
...
func (s *Server) deleteOrder(w http.ResponseWriter, r *http.Request) {
	...
	s.observeDB("delete_order", start, err)
	if err != nil {
		http.Error(w, err.Error(), http.StatusInternalServerError)
		return
	}
